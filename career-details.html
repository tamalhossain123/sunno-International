                     ...
                     <div class="col-xl-8 col-lg-7">
                        <div class="breadcrumb__content z-index-3">
                           ...
                           <div class="breadcrumb__list wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".4s">
                              ...
                              <span class="child-one"><a href="#">Careers page</a></span>
                              <span class="dvdr"><i class="fal fa-angle-right"></i></span>
                     ...
                     <div class="col-xl-7 col-lg-7">
                        <div class="career-details-wrapper">
                           <div class="career-details-title-box">
                              <span>Developer</span>
                              <h4 class="career-details-title">Senior Frontend Developer</h4>
                           </div>
                           ...
                           <div class="career-details-apply-info-box">
                              ...
                              <div class="col-xxl-12">
                                 <div class="postbox__authorization-title-box">
                                    <h5 class="career-details-title-xs pb-15">US work authorization<span>*</span></h5>
                                 </div>
                  ...
                  <div class="row">
                     <div class="col-xl-12">
                        <div class="job-section-box text-center mb-40">
                           <h3 class="tp-section-title">Open Positions</h3>
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-lg-3 col-md-3">
                           <div class="job-post-apply-btn text-start text-md-end">
                              <a class="tp-btn-inner tp-btn-hover alt-color-orange" href=""><span>Apply</span> <b></b></a>
                           </div>
                        </div>
                     </div>
                  </div>
